...
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:teaching/NodeController.dart';
void main(){
  runApp(myapp());
}
class myapp extends StatelessWidget {
...
class _HomeState extends State<Home> {
  NodeController nodeController = Get.put(NodeController());
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    nodeController.getdata();
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder(
        ...
        return ListView.builder(
            itemCount: controller.node?.length,
            itemBuilder: (BuildContext context,index){
          return ListTile(
            title: Text("${controller.node?[index].name}"),
            subtitle: Text("${controller.node?[index].price}"),
          );
        });
      })
    );
...
class InsertScreen extends StatelessWidget {
   ...
   NodeController postController = Get.put(NodeController());
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          CupertinoButton(child: Text("Insert"), onPressed: (){
            postController.postdata(
              name,quantity,price,image
            );

          }),
        CupertinoButton(child: Text("Delete"),onPressed: (){
